...
def parse_demo_configs():
    ...
    parser.add_argument('--pretrained_path', type=str,
                        default='../checkpoints/fpn_resnet_18/Model_fpn_resnet_18_epoch_301.pth', metavar='PATH',
    ...
    configs.dataset_dir = os.path.join(configs.root_dir, 'dataset', 'kitti2', 'training')
    configs.calib_path = os.path.join(configs.root_dir, 'dataset', 'kitti2', 'training', 'calib','000000.txt')
